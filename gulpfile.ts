...
gulp.task('watch', function () {
    ...
    gulp.watch(["client/**/*.html", "client/**/*.css", "client/**/*.png", "client/**/*.jpg", "client/**/*.ico" ], ['clientResources']).on('change', function (e) {
...
gulp.task("build", function (callback) {
    runSequence('clean', 'build:server', 'build:client', 'clientResources', 'serverResources', 'libs', 'css', 'assets', callback);
});

gulp.task('default', function () {
    runSequence('build:server', 'build:client', 'clientResources', 'serverResources', 'libs', 'css', 'assets', 'watch', 'start');
});
